...
/**
 * Precompiled Pertama.java-library-conventions script plugin.
 **/
public class PertamaJavaLibraryConventionsPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_PertamaJavaLibraryConventions").asSubclass(BasicScript.class);
