...
/**
 * Precompiled Pertama.java-common-conventions script plugin.
 **/
public class PertamaJavaCommonConventionsPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_PertamaJavaCommonConventions").asSubclass(BasicScript.class);
